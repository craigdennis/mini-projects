const modal1 = {
  ...
  secret:
    'We have conducted a retina scan and can see that there is NO way we will be able to help you. We will NOT be signing you up for ',
};
...
const modal2 = {
  ...
  secret:
    'AH CRAP! The discount has now expired. Please enjoy your bug filled code in the future',
};
...
const modal3 = {
  ...
  secret:
    'We have limited the amount of downloads due to too much demand. Good Luck with your JavaScript in the future!',
};
